...
<div id="admin_menu_header">
    ...
    <div id="admin_menu_header_inner_alert">Admin page</div>
...
<div id="admin_menu_sidebar">
    <ul>
        <li>MENU</li>
        <li id="admin_menu_sidebar_new" select="now">New members
            <?php $new=$new_count->num_rows();
            if($new > 0){ ?>
                <span id="admin_menu_sidebar_newnum"><?php echo $new; ?></span>
                <?php } ?>
            <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
        </li>
        <li id="admin_menu_sidebar_info" select="">Members info<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></li>
		<li id="test_aprovel_btn" select="">Test Aprovel<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></li>
        <li id="admin_menu_sidebar_test" onClick="popup()" select="">Test<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></li>
		<li id="result_analysis_btn" select="">Result Analysis<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></li>
    </ul>
</div>
