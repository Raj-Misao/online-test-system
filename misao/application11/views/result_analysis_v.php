...
<?php foreach($user_info->result() as $row){ ?>
    <tr>
        ...
        <td>
			<!--<a href="javascript:void;" onClick="popupss()" uid_for_test="<?php echo $row->u_id; ?>"><input class="form-control " type="button"  value="R Check" style="width:50%;background-color:pink;"/></a>-->
