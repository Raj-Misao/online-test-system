				...
				foreach($test_data as $each_qus_data)
				{
					...
					{	
						...
						foreach($each_qus_data as $each_qus_index)
						{
							...
							//echo  '<div  class="col-md-10 " style="margin-top:1%"><input class="'.$qustion_no_type.' btn btn-primary" type="file"/> </div>';
							
							echo  '<div id="container" class="col-md-10 '.$qustion_no_type.'" style="margin-top:1%">';
							//echo base_url().'external/test_images/'.$each_qus_index;
