			...
			{	
				...
				foreach($test_data as $each_qus_data)
				{
					...
					{	
						...
						//echo  '<select class="form-control qustion_type col-sm-6"  style="font-size:medium; font-weight:bolder;color:red;">';
						echo  '<option value="-1" style="font-size:medium; font-weight:bolder;color:blue;">Select Qustion Type</option>';
						echo  '<option value="qno_<?php echo $i;?>__1_imgt" style="font-size:medium; font-weight:bolder;color:blue;">1 -> Image Type Qustion</option>';
						echo  '<option value="qno_<?php echo $i;?>__2_optt" style="font-size:medium; font-weight:bolder;color:blue;">2 -> Optional Type Qustion</option>';
						echo  '<option value="qno_<?php echo $i;?>__3_clozt" style="font-size:medium; font-weight:bolder;color:blue;">3 -> Choose Clue Type Qustion </option>';
						echo  '<option value="qno_<?php echo $i;?>__4_blankqt" style="font-size:medium; font-weight:bolder;color:blue;">4 -> Fillin the Blanks Type Qustion</option>';
					echo  '<select>';
					echo  '<div class=" formetresdiv" style="margin-left:-2%;">';
					...
					echo  '</div>';
						...
						echo '<pre>';
						print_r($each_qus_data);
						echo '</pre>';
						foreach($each_qus_data as $each_qus_index)
						{
							echo  '<div id="container" class="col-md-10 '.$qustion_no_type.'" style="margin-top:1%"><a id="pickfiles" href="javascript:;"><button id=""  type="button" class="pull-left btn btn-primary " >select Image 1st</button></a> <a id="uploadfiles" href="javascript:;"><button type="button" class="pull-left btn btn-primary" style="margin-left:1%;">upload Image</button></a><div id="filelist" class="pull-left" style="margin-left:1%;">No runtime found.</div></div>';
						}
						echo  '</div>';
						echo  '</div>';
						echo  '</div>';
